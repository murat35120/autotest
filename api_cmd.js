let uid;
const vars={
	mark_font_color: '#0000ff',
	mark_font_size:'60px',
	mark_font_family:'Sans-serif',
	mark_text_block:'area.kid-soft.ru',
	mark_show:'flex',
	slogan_font_color: '#8080ff',
	slogan_font_size:'20px',
	slogan_font_family:'Cursive',
	slogan_text_block:'Сервис учета времени и стоимости нахождения в контролируемой зоне',
	slogan_show:'flex',
	baner:'url(baner.jpg)',
	baner_show:'none',
	background:'url(fon.jpg)',
	background_show:'flex',
};
